...
----
# sha256sum /etc/apt/trusted.gpg.d/proxmox-release-trixie.gpg
1bcd2d5bab556076c9ea756a84fe2b7445b13f4ef6e97b2e412b68778377ba6d /etc/apt/trusted.gpg.d/proxmox-release-trixie.gpg
----
...
c94e3775fbafec13fec20f981db61e93 /etc/apt/trusted.gpg.d/proxmox-release-trixie.gpg
----
